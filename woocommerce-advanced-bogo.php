    ...
    public function settings_page() {
        ...
        <div class="wrap">
            ...
            <nav class="nav-tab-wrapper">
                <a href="#discount-rules" class="nav-tab nav-tab-active" data-tab="discount-rules">Discount Rules</a>
                <a href="#ui-settings" class="nav-tab" data-tab="ui-settings">UI Settings</a>
            </nav>

            <!-- Discount Rules Tab -->
            <div id="discount-rules" class="tab-content active">
                ...
                <form method="post" id="bogo-template-form">
                    ...
                    <div class="bogo-template-section" style="margin-bottom: 30px; padding: 20px; background: #f9f9f9; border-radius: 8px;">
                        ...
                        <div class="template-options">
                            ...
                            ?>
                            <div class="template-option <?php echo $selected_template === $template_name ? 'selected' : ''; ?>">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Template option selection styling
