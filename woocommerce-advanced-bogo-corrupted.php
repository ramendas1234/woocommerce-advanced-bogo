...
class WC_Advanced_BOGO {
    ...
    /**
     * Settings page (now redirects to list page)
     */
    public function settings_page() {
        // Redirect old settings page to new list page
        wp_redirect( admin_url( 'admin.php?page=wc-advanced-bogo' ) );
        exit;
    }

    /**
     * UI Settings page (for template settings)
     */
    public function ui_settings_page() {
        ...
        <div class="wrap">
            ...
            <p>Configure the appearance of your BOGO offers on the frontend.</p>
            <!-- Template settings UI will be implemented later -->
        </div>
        <?php
    }
